# Atlas AI Module — Localization

**Paired agent:** `agents/LOCALIZATION_AGENT.md`  
**Purpose:** Operational playbook for i18n architecture and locale QA.
...
- Agent: `agents/LOCALIZATION_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
