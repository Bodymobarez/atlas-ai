# Atlas AI Module — Architecture

**Paired agent:** `agents/SYSTEM_ARCHITECT.md`  
**Purpose:** Operational playbook for C4 views, ADRs, and quality tactics.
...
- Agent: `agents/SYSTEM_ARCHITECT.md`
- Gates: `gates/`
- Workflows: `workflows/`
