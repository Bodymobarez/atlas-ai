# Atlas AI Module — Research

**Paired agent:** `agents/RESEARCH_AGENT.md`  
**Purpose:** Operational playbook for evidence packs and source-indexed research.
...
- Agent: `agents/RESEARCH_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
