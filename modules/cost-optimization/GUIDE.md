# Atlas AI Module — Cost Optimization

**Paired agent:** `agents/COST_OPTIMIZATION_AGENT.md`  
**Purpose:** Operational playbook for cost models, budgets, and tactics.
...
- Agent: `agents/COST_OPTIMIZATION_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
