# Atlas AI Module — Discovery

**Paired agent:** `agents/DISCOVERY_AGENT.md`  
**Purpose:** Operational playbook for stakeholder and problem discovery artifacts.
...
- Agent: `agents/DISCOVERY_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
