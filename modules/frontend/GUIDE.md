# Atlas AI Module — Frontend

**Paired agent:** `agents/FRONTEND_AGENT.md`  
**Purpose:** Operational playbook for web client architecture and journey delivery.
...
- Agent: `agents/FRONTEND_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
