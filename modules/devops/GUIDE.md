# Atlas AI Module — DevOps

**Paired agent:** `agents/DEVOPS_AGENT.md`  
**Purpose:** Operational playbook for CI/CD, environments, and supply chain.
