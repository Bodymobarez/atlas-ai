# Atlas AI Module — Monitor

**Paired agent:** `agents/MONITOR_AGENT.md`  
**Purpose:** Operational playbook for SLOs, signals, dashboards, and alerts.
