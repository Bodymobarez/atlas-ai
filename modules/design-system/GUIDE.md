# Atlas AI Module — Design System

**Paired agent:** `agents/DESIGN_SYSTEM_AGENT.md`  
**Purpose:** Operational playbook for tokens, components, and contribution rules.
...
- Agent: `agents/DESIGN_SYSTEM_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
