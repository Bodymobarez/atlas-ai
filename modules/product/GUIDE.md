# Atlas AI Module — Product

**Paired agent:** `agents/PRODUCT_MANAGER.md`  
**Purpose:** Operational playbook for vision, MVP, backlog, and metrics.
...
- Agent: `agents/PRODUCT_MANAGER.md`
- Gates: `gates/`
- Workflows: `workflows/`
