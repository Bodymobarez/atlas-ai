# Atlas AI Module — Accessibility

**Paired agent:** `agents/ACCESS_AGENT.md`  
**Purpose:** Operational playbook for WCAG targets, reviews, and test protocols.
