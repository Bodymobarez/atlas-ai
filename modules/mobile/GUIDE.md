# Atlas AI Module — Mobile

**Paired agent:** `agents/MOBILE_AGENT.md`  
**Purpose:** Operational playbook for mobile applicability, architecture, and store readiness.
