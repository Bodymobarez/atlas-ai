# Atlas AI Module — Database

**Paired agent:** `agents/DATABASE_AGENT.md`  
**Purpose:** Operational playbook for data modeling, lifecycle, and migrations policy.
...
- Agent: `agents/DATABASE_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
