# Atlas AI Module — Backend

**Paired agent:** `agents/BACKEND_AGENT.md`  
**Purpose:** Operational playbook for services, invariants, and resilience.
