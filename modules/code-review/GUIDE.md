# Atlas AI Module — Code Review

**Paired agent:** `agents/CODE_REVIEW_BOARD.md`  
**Purpose:** Operational playbook for multi-seat review checklists and policy.
...
- Agent: `agents/CODE_REVIEW_BOARD.md`
- Gates: `gates/`
- Workflows: `workflows/`
