# Atlas AI Module — Business Analysis

**Paired agent:** `agents/BUSINESS_ANALYST.md`  
**Purpose:** Operational playbook for requirements, rules, and traceability.
...
- Agent: `agents/BUSINESS_ANALYST.md`
- Gates: `gates/`
- Workflows: `workflows/`
