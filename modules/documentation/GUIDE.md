# Atlas AI Module — Documentation

**Paired agent:** `agents/DOCUMENTATION_AGENT.md`  
**Purpose:** Operational playbook for docs IA, accuracy, and agent entrypoints.
...
- Agent: `agents/DOCUMENTATION_AGENT.md`
- Gates: `gates/`
- Workflows: `workflows/`
