...
window.ATLAS_EVOLVE_QUESTIONS = [
  ...
  },
  {
    id: "E18",
    piece: "INTEGRATIONS",
    title: "هل هذه الجولة تضيف أو تعدّل ربطًا خارجيًا؟",
    hint: "أي Stripe / Slack / WhatsApp / SSO / Webhooks / MCP / …",
    researchTip: "راجع modules/integrations/CONNECTION_TYPES.md و PLATFORMS_CATALOG.md",
    recommended: "B",
    options: [
      { id: "A", label: "لا — بدون تكاملات خارجية" },
      { id: "B", label: "نعم — تكامل موجود نعدّله" },
      { id: "C", label: "نعم — تكامل جديد" },
      { id: "D", label: "عدة تكاملات في هذه الجولة" },
    ],
  },
  {
    id: "E19",
    piece: "INTEGRATIONS",
    title: "أنواع الربط المطلوبة؟ (متعدد)",
    multi: true,
    skipIf: { questionId: "E18", optionIds: ["A"] },
    recommended: ["A", "C"],
    options: [
      { id: "A", label: "REST / GraphQL API" },
      { id: "B", label: "OAuth / OIDC / SSO / SAML" },
      { id: "C", label: "Webhooks واردة/صادرة" },
      { id: "D", label: "WebSocket / SSE / طوابير أحداث" },
      { id: "E", label: "SDK مضمّن (ويب/موبايل)" },
      { id: "F", label: "MCP / أدوات ذكاء اصطناعي" },
      { id: "G", label: "ملفات SFTP / تخزين كائنات / بريد" },
      { id: "H", label: "iPaaS (Zapier/n8n) كغراء فقط" },
    ],
  },
  {
    id: "E20",
    piece: "INTEGRATIONS",
    title: "فئة المنصة الأساسية؟ (متعدد إن لزم)",
    multi: true,
    skipIf: { questionId: "E18", optionIds: ["A"] },
    options: [
      { id: "A", label: "مدفوعات / مالية" },
      { id: "B", label: "هوية / SSO" },
      { id: "C", label: "تواصل (Slack/WhatsApp/SMS/Email)" },
      { id: "D", label: "سحابة / DevOps / GitHub" },
      { id: "E", label: "CRM / تسويق / تحليلات" },
      { id: "F", label: "تجارة / سوق / شحن" },
      { id: "G", label: "خرائط / سفر / لوجستيات" },
      { id: "H", label: "AI / Vector / LLM" },
      { id: "I", label: "أخرى — اكتب الاسم في الملاحظة" },
    ],
  },
  {
    id: "E21",
    piece: "INTEGRATIONS",
    title: "متطلبات الموثوقية والأمان للربط؟ (متعدد)",
    multi: true,
    skipIf: { questionId: "E18", optionIds: ["A"] },
    recommended: ["A", "B", "C"],
    options: [
      { id: "A", label: "تحقق توقيع Webhook + منع التكرار" },
      { id: "B", label: "Idempotency على العمليات الحساسة" },
      { id: "C", label: "أسرار في Vault/KMS — لا مفاتيح في الفرونت" },
      { id: "D", label: "Sandbox أولًا ثم ترقية إنتاج" },
      { id: "E", label: "Feature flag قبل التعميم" },
      { id: "F", label: "Runbook إعادة إرسال / قطع الربط" },
    ],
  },
  {
    id: "E22",
